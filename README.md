...
In the `src/com.codepath.twitterclient.models`, create the models that represent the key data to be parsed and persisted within your application.
...
Open `src/com.codepath.twitterclient/LoginActivity.java` and configure the `onLoginSuccess` method
